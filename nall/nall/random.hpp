...
//Note: this fork drops the XChaCha20 CSPRNG (and its nall/cipher/chacha20.hpp
//dependency) that upstream nall ships here; nothing in ares uses it. Only the PRNG
//generators and the nall::random() free function below are kept.
