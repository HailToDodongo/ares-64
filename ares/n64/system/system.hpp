struct System {
  ...
  //2 = none (RDP commands are no-ops; the software VI still scans out RDRAM).
  enum class Renderer : u32 { ParallelRDP, Angrylion, None };
...
private:
  ...
  atomic<bool> _rendererNeedsLoad = false;
